...
//Promise polly fill - https://github.com/taylorhakes/promise-polyfill
(function() {
...
function fetchIssues(callback) {
  ...
  /*return http.get('https://www.kimonolabs.com/api/dsun5vv4?&apikey=VcJUuOZizXZr5J7vwfFzff3Tt6m6q5t7&kimmodify=1', function(response) {
    ...
    var data = JSON.parse(body);
        console.log(body);
    callback(null, data.results, data.thisversionrun);
    });*/

    /*fajax.defaults({
        accept: 'application/json'
    })
    fajax.get('https://www.kimonolabs.com/api/dsun5vv4?&apikey=VcJUuOZizXZr5J7vwfFzff3Tt6m6q5t7&kimmodify=1').then(function(xhr) {
        callback(null, xhr.body.results, xhr.body.thisversionrun);
    });*/
}
